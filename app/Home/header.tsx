...
export default function Header(){
    ...
    return(<div className="absolute top-8 w-full h-auto flex items-center justify-center">
        ...
        <div className="relative w-10 h-10 flex justify-center items-center rounded-full bg-blue-600/70">
        ...
        <div className="relative w-[20%] max-w-40 h-10 bg-white/80 rounded-full flex justify-center items-center bg-linear-to-tr from-blue-600/75 to-blue-800/80"><h1 className={`font-sans text-[16px]`}>Contact Me</h1></div>
        </div>
    </div>)
}