    ...
    return(<div className="relative w-full py-20 h-auto bg-black/98 flex flex-col items-center">
        ...
        <div className="relative mt-20 w-[95%] h-auto max-w-300 flex flex-col">
            <div className="relative w-full flex flex-col md:flex-row">
                <div className="relative w-full h-auto my-4 md:mx-4 border border-white/60 p-4 md:p-6 rounded-xl shadow-lg shadow-white/20">
                ...
                <div className="relative w-full h-auto my-4 md:mx-4 border border-white/60 px-4 py-2 rounded-xl shadow-lg shadow-white/20">
