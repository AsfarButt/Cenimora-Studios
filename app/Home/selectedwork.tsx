        ...
        <div className="relative mt-12 w-full max-w-330 h-full flex flex-col xl:flex-row items-center justify-center">
                ...
                <div className="relative w-auto h-auto flex items-center justify-center flex-col md:flex-row">
                    <div className="relative w-100 h-75 md:w-75 md:h-80 transition-all duration-400 m-4 md:mx-6 lg:mx-8 rounded-2xl bg-[url('/bgimage1.jpg')] bg-center bg-cover shadow-lg shadow-blue-200/40 before:absolute before:inset-0 before:bg-black/30 before:z-1 overflow-hidden group">
                        <div className="absolute bottom-0 overflow-hidden h-[28%] [box-shadow:0px_0px_5px_rgba(0,0,0,0.4)] before:absolute before:inset-0 before:bg-black/1 group-hover:before:bg-black/10 before:transition-all before:duration-400 w-[96%] m-1 transition-all duration-400 ease-in backdrop-blur-sm rounded-2xl group-hover:w-full group-hover:h-full group-hover:m-0">
            ...
            // <div className="relative px-2 w-full h-auto mt-8 flex flex-col items-center justify-center sm:flex-col md:flex-col lg:flex-row animation-style-preserver-3d">
            //     <div className="relative w-full lg:w-[50%] h-full  flex flex-row justify-evenly items-center">
            //         <div className="relative w-70 h-80 rounded-2xl bg-blue-800/20 shadow-lg shadow-blue-200/40">
            //         <div className="absolute bottom-1 h-[35%] w-[94%] m-2 bg-white/10 rounded-2xl">
            //         <div className=""><div className="relative w-8 h-8 rounded-full bg-white/20 border border-white/70 text-2xl font-bold font-sans">1</div></div>
            //         <div className=""></div>
            //         </div>
            //         </div>
            //         <div className="relative w-70 h-80 rounded-2xl bg-blue-800/20 shadow-lg shadow-blue-200/40">
            //         <div className="absolute bottom-1 h-[35%] w-[94%] m-2 bg-white/10 rounded-2xl">
            //         <div className=""><div className="relative w-8 h-8 rounded-full bg-white/20 border border-white/70 text-2xl font-bold font-sans">2</div></div>
            //         <div className=""></div>
            //         </div>
            //         </div>
            //     </div>
            //     <div className="relative w-[80%] lg:w-[50%] h-full">
            ...
            // <div className="relative px-2 w-full h-auto mt-8 flex flex-col items-center justify-center sm:flex-col md:flex-col lg:flex-row">
            ...
            //         <div className="relative w-70 h-80 rounded-2xl bg-blue-800/20 shadow-lg shadow-blue-200/40">
            //         <div className="absolute bottom-1 h-[35%] w-[94%] m-2 bg-white/10 rounded-2xl">
            //         <div className=""><div className="relative w-8 h-8 rounded-full bg-white/20 border border-white/70 text-2xl font-bold font-sans">3</div></div>
            //         <div className=""></div>
            //         </div>
            //         </div>
            //         <div className="relative w-70 h-80 rounded-2xl bg-blue-800/20 shadow-lg shadow-blue-200/40">
            //         <div className="absolute bottom-1 h-[35%] w-[94%] m-2 bg-white/10 rounded-2xl">
            //         <div className=""><div className="relative w-8 h-8 rounded-full bg-white/20 border border-white/70 text-2xl font-bold font-sans">4</div></div>
            //         <div className=""></div>
            //         </div>
            //         </div>
            //     </div>
